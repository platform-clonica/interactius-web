...
const TEAM = [
  { src: '/identidad/fotos-team/team-Tom.png', name: 'Tomas Modroño', role: 'Partner' },
  { src: '/identidad/fotos-team/team-Adrian.png', name: 'Adrián Yanes', role: 'Design' },
  { src: '/identidad/fotos-team/team-Ale.png', name: 'Alejandro Madeira', role: 'Strategy' },
  { src: '/identidad/fotos-team/team-Aleix.png', name: 'Aleix Martí', role: 'Engineering' },
  { src: '/identidad/fotos-team/team-Alex.png', name: 'Alex Cuadrado', role: 'Research' },
  { src: '/identidad/fotos-team/team-Alexa.png', name: 'Alexa', role: 'Design' },
  { src: '/identidad/fotos-team/team-Berta.png', name: 'Berta', role: 'Operations' },
  { src: '/identidad/fotos-team/team-Carlos.png', name: 'Carlos', role: 'Partner' },
  { src: '/identidad/fotos-team/team-Diana.png', name: 'Diana', role: 'Strategy' },
  { src: '/identidad/fotos-team/team-Diego.png', name: 'Diego', role: 'Engineering' },
  { src: '/identidad/fotos-team/team-Edmond.png', name: 'Edmond', role: 'Design' },
  { src: '/identidad/fotos-team/team-Elena_S.png', name: 'Elena S.', role: 'Design' },
  { src: '/identidad/fotos-team/team-Eli.png', name: 'Eli López', role: 'Strategy' },
  { src: '/identidad/fotos-team/team-Francesc.png', name: 'Francesc', role: 'Engineering' },
  { src: '/identidad/fotos-team/team-Isaac.png', name: 'Isaac', role: 'Design' },
  { src: '/identidad/fotos-team/team-Josep.png', name: 'Josep', role: 'Partner' },
  { src: '/identidad/fotos-team/team-Martina.png', name: 'Martina Gentile', role: 'Head of Marketing' },
] as const
