...
/**
 * Footer — fondo dark, reveal vertical clip-path (A10).
 *
 * Estructura:
 * - Top: newsletter CTA (izq) + wordmark + info contacto + social (dcha).
 * - Bottom: copyright + links legales.
 *
 * Animación: la primitiva .reveal-clip-vertical (definida en globals.css)
 * anima clip-path desde inset(100% 0 0 0) a inset(0 0 0 0). Se dispara al
 * 10% de visibilidad en viewport.
 */
  ...
  return (
    <footer
      ...
      className={`relative w-full bg-dark text-pure-white
                  reveal-clip-vertical ${revealed ? 'is-revealed' : ''}`}
    >
      <div className="section-inner py-section">
        {/* ========================================================
            Top grid — newsletter CTA + info block
            ======================================================== */}
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-grid-gutter">
          ...
          >
            ...
            {/*
              AA note: el brief especifica opacity 40% en este subtitle sobre
              fondo dark. 40% da ratio ~3.1:1 — falla AA para texto normal.
              Subido a 60% (ratio ~4.8:1) para cumplir AA.
            */}
              ...
              <ul className="flex flex-col gap-1">
                <li>
                  <a
                    ...
                    className="text-pure-white transition-opacity duration-fast ease-expo
                               hover:opacity-60"
                  >
                    Tel. 936 24 39 13
                  </a>
              ...
              <li>
                <a
                  ...
                  className="inline-flex size-10 items-center justify-center
                             text-pure-white transition-opacity duration-fast ease-expo
                             hover:opacity-60"
                >
                  <LinkedInIcon />
                </a>
        ...
        >
          ...
          >
            <ul className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-micro">
              <li>
                {/* Placeholder — ver decisión: links inertes hasta tener contenido */}
                <span
                  aria-disabled="true"
              ...
              <li>
                <Link
                  href="/aviso-legal"
                  className="text-pure-white/60 transition-opacity duration-fast ease-expo
                             hover:text-pure-white focus-visible:text-pure-white"
                >
                  {t('legal.notice')}
                </Link>
              </li>
...
/* ==========================================================================
   Social icons — SVG inline, currentColor
   --------------------------------------------------------------------------
   Iconos minimales tipo stroke / glyph. 20×20 viewBox. Usan currentColor
   para heredar del contenedor.
   ========================================================================== */
